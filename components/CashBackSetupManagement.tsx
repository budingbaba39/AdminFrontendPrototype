...
export default function CashBackSetupManagement() {
  ...
  const handleAddTier = () => {
    setFormData(prev => ({
      ...prev,
      amountTiers: [...prev.amountTiers, { amountMoreThanOrEqual: 0, cashbackPercentage: 0, cashbackAmount: 0 }]
    }));
  };
  ...
  const handleTierChange = (index: number, field: 'amountMoreThanOrEqual' | 'cashbackPercentage' | 'cashbackAmount', value: number) => {
    setFormData(prev => {
                      ...
                      <table className="w-full">
                        <thead className="bg-gray-50">
                          <tr>
                            ...
                            <th className="px-3 py-2 text-left text-xs font-semibold text-gray-900 uppercase">{getProviderTargetLabel()}</th>
                            <th className="px-3 py-2 text-left text-xs font-semibold text-gray-900 uppercase">CashBack %</th>
                              ...
                              <tr key={provider.id} className="hover:bg-gray-50">
                                ...
                                <td className="px-3 py-2">
                                  <Input
                                    ...
                                    onChange={(e) => handleProviderSettingChange(provider.id, 'targetAmount', Number(e.target.value))}
                                    placeholder="0"
                                ...
                                <td className="px-3 py-2">
                                  <Input
                                    ...
                                    onChange={(e) => handleProviderSettingChange(provider.id, 'cashbackPercentage', Number(e.target.value))}
                                    placeholder="0"
